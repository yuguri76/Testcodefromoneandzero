...
public class ImageService {
    ...
    @Transactional
    public ResponseEntity<String> uploadImageToNewsfeed(String token, Long id, MultipartFile file) {
     ...
     */
    @Transactional
    public ResponseEntity<String> updateImageToNewsfeed(String token, MultipartFile file, Long id,
        Long changeFileid) {
        // 파일 유효성 검사
        validFile(file);
